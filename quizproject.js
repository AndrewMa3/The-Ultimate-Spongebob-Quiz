...
function hintBtn() {
  ...
  if (currentQuestion == 0) {
    document.getElementById("hint").innerHTML = "A sponge and this house could be somewhere in a kitchen...";
  }
  else if (currentQuestion == 1){
    document.getElementById("hint").innerHTML = '"G___ the snail"'
  }
  else if (currentQuestion == 2){
    document.getElementById("hint").innerHTML = "He plays it with his mouth..."
  }
  else if (currentQuestion == 3){
    document.getElementById("hint").innerHTML = "Hint 2"
  }
  else if (currentQuestion == 4){
    document.getElementById("hint").innerHTML = "He is a horrible boater..."
  }
  else if (currentQuestion == 5){
    document.getElementById("hint").innerHTML = "Squirrels put nuts somewhere in their mouths..."
  }
  else if (currentQuestion == 6){
    document.getElementById("hint").innerHTML = "Plankton could use his small sneakiness for this..."
  }
  else if (currentQuestion == 7){
    document.getElementById("hint").innerHTML = "A feline could make this sound..."
  }
  else if (currentQuestion == 8){
    document.getElementById("hint").innerHTML = "D-bob..."
  }
  else{
    document.getElementById("hint").innerHTML = "Patrick doesn't know his animals..."
  }
